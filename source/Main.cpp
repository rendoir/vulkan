...
const std::string MODEL_PATH = "resources/models/chalet/chalet.obj";
const std::string TEXTURE_PATH = "resources/models/chalet/chalet.jpg";
...
private:
    ...
    void createGraphicsPipeline() {
        auto vertShaderCode = readFile("build/shaders/unlit.vs.spv");
        auto fragShaderCode = readFile("build/shaders/unlit.fs.spv");
